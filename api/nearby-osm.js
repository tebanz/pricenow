...
function normalizeOverpassElement(element, origin) {
  ...
  return {
    ...
    commune: tags['addr:municipality'] || tags['addr:city'] || tags['is_in:city'] || '',
...
function normalizeNominatimPlace(place, origin) {
  ...
  return {
    ...
    city: place.address?.city || place.address?.town || place.address?.locality || place.address?.village || '',
    commune: place.address?.municipality || place.address?.county || place.address?.city || place.address?.town || place.address?.locality || '',
